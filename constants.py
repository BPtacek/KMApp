...
size_thresholds = {0:0,9:1,24:2,49:3,99:4} # Dict, number of claimed hexes corresponding to upper limit for indicated size penalty
control_DC_table = {1:14,2:15,3:16,4:18,5:20,6:22,7:23,8:24,9:26,10:27,11:28,12:30,13:31,14:32,
                    15:34,16:35,17:36,18:38,19:39,20:40} # {Kingdom level:control DC}
leadership_status_bonuses = {1:1,8:2,16:3} # kingdom level and associated status bonus to skill checks for filling leadership
settlement_consumption_scaling = {1:1,4:2,9:4,10:6} # {settlement size threshold : settlement consumption value}. 

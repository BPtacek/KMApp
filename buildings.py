...
Brewery = Building("Brewery", 1, 1, [6,2,0,0,0], ["Agriculture",0,15],1,[0,0,0,0,0],False,False,{"Establish Trade Agreement":1},{})  
...
Inn = Building("Inn",1,1,[10,2,0,0,0], ["Wilderness",0,15],0,[0,0,0,0,0],False,False,{"Hire Adventurers":1},{})
Shrine = Building("Shrine",1,1,[8,2,1,0,0], ["Folklore",0,15],0,[0,0,0,0,0],False,False,{"Celebrate Holiday":1},{})
...
Jail = Building("Jail",1,2,[14,4,4,2,0],["Defense",0,16],0,[0,0,-1,0,0],False,False,{"Quell Unrest (Intrigue)":1},{})
Library = Building("Library",1,2,[6,4,2,0,0],["Scholarship",1,16],0,[0,0,0,0,0],False,False,{"Rest and Relax (Scholarship)":1},
                   {"Recall Knowledge (Lore)":1, "Research":1,"Decipher Writing":1})
Mill = Building("Mill",1,2,[6,2,1,0,0],["Industry",1,16],0,[0,0,0,0,0],True,False,{"Harvest Crops":1},{})
...
Barracks = Building("Barracks",1,3,[6,2,1,0,0],["Defense",0,18],1,[0,0,0,0,0],False,False,
...
Watchtower = Building("Watchtower",1,3,[12,4,4,0,0],["Defense",1,18],1,[0,0,0,0,0],False,False,
                      {"Resolve Events":1},{})
Marketplace = Building("Marketplace",2,4,[48,4,0,0,0],["Trade",1,19],0,[0,0,0,0,0],False,False,
                       {"Establish Trade Agreement":1},{})
Pavedstreets = Building("Paved Streets",0,4,[12,0,6,0,0],["Industry",1,19],0,[0,0,0,0,0],False,False,{},{})
Specialartisan = Building("Specialized Artisan",1,4,[10,4,0,0,1],["Trade",2,19],0,[0,0,0,0,0],False,False,
...
Garrison = Building("Garrison",2,5,[28,6,3,0,0],["Warfare",1,20],1,[0,0,0,0,0],False,False,
                    {"Outfit Army":1,"Train Army":1},{})
Guildhall = Building("Guildhall",2,5,[34,8,0,0,0],["Trade",2,20],0,[0,0,0,0,0],False,False,{},{})
Magiclamps = Building("Magical Street Lamps",0,5,[20,0,0,0,0],["Magic",2,20],0,[0,0,1,0,0],False,False,{},{})
Mansion = Building("Mansion",1,5,[10,6,3,0,6],["Industry",1,20],0,[0,0,0,0,0],False,True,{"Improve Lifestyle":1},{})
...
Buildings = (Rubble,Tenement,Brewery,Cemetery,GeneralStore,Granary,Herbalist,Houses,Inn,Shrine,DiveTavern,WoodenWall,Bridge,
             Dump,Jail,Library,Mill,Orphanage,TownHall,AlchemyLab,PopularTavern,Barracks,Foundry,FestivalHall,Foundry,Keep,
             Lumberyard,Monument,Park,Pier,Smithy,Stable,Stockyard,Stonemason,Tannery,TradeShop,Watchtower,Marketplace,
             Pavedstreets,Specialartisan,Arcanist,Bank,Garrison,Guildhall,Magiclamps,Mansion,Museum,Sacredgrove)